...
Take the CSV export task on autopilot.
Tell me what you need from me and how I can try the result when it is ready.
```

<Note>
  Autopilot still stops for decisions that need you by default. Running without questions is a
  separate, explicit setting; see [Without stops](#without-stops).
</Note>
