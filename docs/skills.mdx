...
| `jig-review` | After implementation of structural or bigger work | Reviews the actual diff against the requirements, the rules, the project's contracts and the evidence, and records each finding with a severity. | Whether a serious finding may be dismissed instead of fixed. |
